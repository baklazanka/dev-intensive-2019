...
class AvatarImageViewFromLesson @JvmOverloads constructor(
    context: Context,
...
//    private var rect: Rect = Rect()
    ...
    // В уроке использовалось pathR: Path = Path(),
    // хотя в видео мелькнул только кусочек кода, без реализации
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        //pathR.addOval(rect, Path.Direction.CW)
